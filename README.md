...
2. **Material Optimization**: Solving the combinatoric 1D _Cutting Stock Problem_ to compute optimal cutting patterns from standard 12-meter rebars, significantly minimizing steel scrap (_waste_).
...
Where the _Factor_ is typically standard structural values like $40d$ or $50d$.
