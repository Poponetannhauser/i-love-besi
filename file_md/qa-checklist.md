...
| #   | Langkah                                                                     | Expected Result                                      | Status |
| --- | --------------------------------------------------------------------------- | ---------------------------------------------------- | ------ |
| 3.1 | HITUNG SENGKANG tanpa isi apapun                                            | Error: "Lebar dan tinggi harus berupa angka positif" | [x]    |
| 3.2 | Isi: Lebar=20, Tinggi=40, Cover=2.5, Kait=10, PjgBalok=4.0, Jarak=15, Qty=3 | Live preview muncul                                  | [x]    |
| 3.3 | Verifikasi panjang 1 sengkang                                               | 2x(17.5+35)=105cm, total=(105+20)/100 = 1.25 m       | [x]    |
| 3.4 | Verifikasi jumlah sengkang                                                  | (4.0x100/15)x3 = ~80 pcs                             | [x]    |
| 3.5 | Klik HITUNG & TAMBAH SENGKANG                                               | Item muncul di tabel DATA REBAR AKTIF                | [x]    |
| 3.6 | Cover=15cm, Lebar=20cm                                                      | Error: "Tebal selimut beton melebihi ukuran beton"   | [x]    |
...
| #   | Langkah                                | Expected Result                                           | Status |
| --- | -------------------------------------- | --------------------------------------------------------- | ------ |
| 4.1 | Tambahkan D10: 3.0mx4pcs dan 4.5mx2pcs | Skema pemotongan tampil di panel SKEMA PEMOTONGAN         | [x]    |
| 4.2 | Verifikasi POLA 1: 4.5+4.5+3.0=12.0m   | Pattern: ZERO WASTE                                       | [x]    |
| 4.3 | Verifikasi TOTAL STOCK DIBUTUHKAN      | Sesuai hasil FFD                                          | [x]    |
| 4.4 | Verifikasi EFISIENSI %                 | = total panjang potong / (total batang x 12) x 100%       | [x]    |
| 4.5 | Buka tab Cut Lists                     | Pattern card muncul dengan visual bar dan tabel instruksi | [x]    |
...
| #   | Langkah                  | Expected Result                          | Status |
| --- | ------------------------ | ---------------------------------------- | ------ |
| 5.1 | Kolom DESKRIPSI & INFO   | Nama elemen tampil bold                  | [x]    |
| 5.2 | Item BjTP                | Sub-baris menampilkan "Polos"            | [x]    |
| 5.3 | Item BjTS                | Sub-baris menampilkan "Ulir"             | [x]    |
| 5.4 | Item dengan overlap      | Sub-baris: Overlap +Xm                   | [x]    |
| 5.5 | Item dengan banci        | Sub-baris: Banci (X.Xmm)                 | [x]    |
| 5.6 | Klik ikon hapus di baris | Baris terhapus                           | [x]    |
| 5.7 | Klik Hapus Semua         | Semua baris terhapus, empty state muncul | [x]    |
| 5.8 | Refresh browser (F5)     | Data masih ada (localStorage persists)   | [x]    |
...
| #   | Langkah                          | Expected Result                                     | Status |
| --- | -------------------------------- | --------------------------------------------------- | ------ |
| 6.1 | Buka tab Inventory               | Halaman muncul tanpa crash                          | [x]    |
| 6.2 | Cek tabel MASTER REBAR LEDGER    | Setiap diameter + tipe besi = 1 baris               | [x]    |
| 6.3 | Kolom GRADE untuk BjTS           | Menampilkan "BjTS 420 (Ulir)" (bukan "BJTS 420B")   | [x]    |
| 6.4 | Kolom GRADE untuk BjTP           | Menampilkan "BjTP 280 (Polos)"                      | [x]    |
| 6.5 | BERAT NOMINAL — item tanpa banci | Nominal = Aktual                                    | [x]    |
| 6.6 | BERAT AKTUAL — item dengan banci | Berat aktual < nominal                              | [x]    |
| 6.7 | Footer tabel                     | Menampilkan: "X.XX kg (Nominal) / Y.YY kg (Aktual)" | [x]    |
| 6.8 | Badge STATUS semua baris         | "RECORDED" (berwarna hijau)                         | [x]    |
...
| #   | Langkah                | Expected Result                                  | Status |
| --- | ---------------------- | ------------------------------------------------ | ------ |
| 7.1 | Klik preset D10 - 2.5M | Form: D=10, Panjang=2.5, Qty=100, Nama=Kolom D10 | [x]    |
| 7.2 | Klik preset D13 - 4.0M | Form terisi nilai D13                            | [x]    |
| 7.3 | Klik preset D16 - 3.2M | Form terisi nilai D16                            | [x]    |
...
| #   | Langkah                         | Expected Result                                  | Status |
| --- | ------------------------------- | ------------------------------------------------ | ------ |
| 8.1 | Di Proyek A, tambahkan 3 item   | Data tersimpan                                   | [x]    |
| 8.2 | Pindah ke Proyek B, buka Inputs | Tabel kosong (data Proyek A tidak bocor)         | [x]    |
| 8.3 | Tambahkan 2 item di Proyek B    | Data B tersimpan                                 | [x]    |
| 8.4 | Kembali ke Proyek A             | 3 item Proyek A masih ada                        | [x]    |
| 8.5 | Refresh browser                 | Kedua proyek dengan data masing-masing tetap ada | [x]    |
...
| #   | Langkah                                | Expected Result                                              | Status |
| --- | -------------------------------------- | ------------------------------------------------------------ | ------ |
| 9.1 | Buka Dashboard (ada item di recapList) | Stat cards menampilkan angka non-zero                        | [x]    |
| 9.2 | Stat TOTAL OPTIMIZED                   | Menampilkan total berat dalam format "X.XX tn"               | [x]    |
| 9.3 | Stat MATERIAL EFFICIENCY               | Angka konsisten dengan efisiensi di tab Inputs               | [x]    |
| 9.4 | Tabel RECENT CUT LIST PERFORMANCE      | 4 item terakhir tampil                                       | [x]    |
| 9.5 | Di 768px (iPad) — 3 stat card          | Tersusun horizontal simetris, tidak ada card lebar sendirian | [x]    |
...
| #    | Langkah                                | Expected Result                             | Status |
| ---- | -------------------------------------- | ------------------------------------------- | ------ |
| 10.1 | Mobile: klik hamburger                 | Drawer sidebar muncul dari kiri             | [x]    |
| 10.2 | Klik di luar drawer                    | Drawer tertutup                             | [x]    |
| 10.3 | Klik item navigasi di drawer           | Pindah ke halaman, drawer tertutup otomatis | [x]    |
| 10.4 | Klik logo ILOVEBESI di sidebar         | Kembali ke landing page                     | [x]    |
| 10.5 | Scroll tabel Inventory di mobile       | Tabel bisa di-scroll horizontal             | [x]    |
| 10.6 | Klik tombol Floating + (FAB) di Inputs | Sama dengan klik HITUNG & TAMBAH            | [x]    |
...
| #    | Langkah                                     | Expected Result                                  | Status |
| ---- | ------------------------------------------- | ------------------------------------------------ | ------ |
| 11.1 | Tambahkan 20+ item dengan diameter campuran | App responsif, tabel dan pattern render benar    | [x]    |
| 11.2 | Item panjang tepat 12.0m                    | Pattern: 1 batang 1 potongan, ZERO WASTE         | [x]    |
| 11.3 | Aktifkan Overlap + Besi Banci bersamaan     | Live preview menampilkan kedua info, tidak crash | [x]    |
| 11.4 | Sengkang di Inventory                       | Grade sesuai tipe besi (BjTP/BjTS)               | [x]    |
